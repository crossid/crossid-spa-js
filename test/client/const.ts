export const TEST_ISSUER = 'https://myorg.crossid.io/oauth2/default/'

export const TEST_AUDIENCE = ['myorg.com']

export const TEST_SCOPE = 'openid'

export const TEST_AUTHORIZATION_ENDPOINT =
  'https://myorg.crossid.io/oauth2/default/auth'
